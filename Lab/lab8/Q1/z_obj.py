...
def retrive_account(username):
    return root.cusomers[username]
...
class CurrentAccount(Account, persistent.Persistent):
    ...
    def __str__(self):
        return f"CurrentAccount: Owner: {self.owner.name}, Balance: {self.balance}, Limit: {self.limit}"
...
class SavingAccount(Account, persistent.Persistent):
    ...
    def __str__(self):
        return f"SavingAccount: Owner: {self.owner.name}, Balance: {self.balance}, Interest: {self.interest}"
